 ...
 * @author Rolan
 */
public class RegistroMateriasCO extends javax.swing.JFrame {

    /**
     * Creates new form RegistroMaterias
     */
    public RegistroMateriasCO() {
        initComponents();
        setSize(1000, 600);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroMateriasCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroMateriasCO().setVisible(true);
            }
        });
    }
