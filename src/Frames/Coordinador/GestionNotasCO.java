 ...
 * @author Rolan
 */
public class GestionNotasCO extends javax.swing.JFrame {

    /**
     * Creates new form GestionNotas
     */
    public GestionNotasCO() {
        initComponents();
        setSize(800, 500);
        ...
        setTitle("Mantenimiento Notas - Coordinador");
        cargarcbMaterias();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionNotasCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionNotasCO().setVisible(true);
            }
        });
    }
