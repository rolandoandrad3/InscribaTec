 ...
 * @author Rolan
 */
public class RegistroCarreraCO extends javax.swing.JFrame {

    /**
     * Creates new form RegistroCarrera
     */
    public RegistroCarreraCO() {
        initComponents();
        cerrar();
        setSize(800, 520);
        ...
        setTitle("Registro de Carreras - Coordinador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroCarreraCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroCarreraCO().setVisible(true);
            }
        });
    }
