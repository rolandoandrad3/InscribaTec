 ...
 * @author Rolan
 */
public class RegistrarCalificacionProf extends javax.swing.JFrame {
     ...
     */
    public RegistrarCalificacionProf() {
        initComponents();
        setSize(700, 600);
        ...
        setTitle("Registrar Calificaciones - Profesor");
        cerrar();
        cargarcbMaterias();
        cargarDatosCarnet("");
...
private void limpiarCampos() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarCalificacionProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarCalificacionProf().setVisible(true);
            }
        });
    }
