 ...
 * @author Rolan
 */
public class RegistrarEstudianteCO extends javax.swing.JFrame {

    /**
     * Creates new form RegistrarEstudiante
     */
    public RegistrarEstudianteCO() {
        initComponents();
        ...
        setTitle("Registro de Estudiantes - Coordinador");
...
// Método para validar email usando una expresión regular
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ListarEstudiantesCO ls = new ListarEstudiantesCO();
        ls.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarEstudianteCO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarEstudianteCO().setVisible(true);
            }
        });
    }
